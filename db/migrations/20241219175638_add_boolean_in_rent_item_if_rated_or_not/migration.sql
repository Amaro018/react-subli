...
INSERT INTO "new_RentItem" ("createdAt", "deliveryMethod", "endDate", "id", "price", "productVariantId", "quantity", "rentId", "startDate", "status", "updatedAt") SELECT "createdAt", "deliveryMethod", "endDate", "id", "price", "productVariantId", "quantity", "rentId", "startDate", "status", "updatedAt" FROM "RentItem";
DROP TABLE "RentItem";
